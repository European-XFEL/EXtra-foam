import time
import pytest
from widgets.pyqtgraph.Qt import QtGui, QtTest
import numpy as np
from widgets import pyqtgraph as pg
from widgets.pyqtgraph.tests import assertImageApproved, TransposedImageItem
...
@pytest.mark.skipif(widgets.pyqtgraph.Qt.QT_LIB == 'PySide', reason="pyside does not have qWait")
def test_dividebyzero():
    import widgets.pyqtgraph as pg
