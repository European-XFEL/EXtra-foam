...
from ..data_model import ProcessedData, RawImageData
...
class ImageProcessor(CompositeProcessor):
    ...
    def process(self, data):
        ...
        ImageProcessor._raw_data.window = self._ma_window
        ...
        image_shape = self._raw_data.shape[-2:]
